...
<header>
  ...
  <li class="nav-item px-2"> 
    <a href="tel:<?php echo get_settings('phone'); ?>">
      <i class="fa-solid fa-phone" style="color: #039080;"></i> <?php echo get_settings('phone'); ?>
    </a>
  </li>
  <div class="vartical"></div>
  <li class="nav-item px-2">
    <a href="mailto:<?php echo get_settings('system_email'); ?>">
      <i class="fas fa-envelope" style="color: #039080;"></i> <?php echo get_settings('system_email'); ?>
    </a>
  </li>
</ul>
